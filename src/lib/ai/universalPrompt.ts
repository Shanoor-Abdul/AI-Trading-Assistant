...

{
  ...
  "confidence": 90,
  "marketStructureAnalysis": "Analyze the highs, lows, and regime.",
  "liquidityZonesIdentified": "Where is the liquidity?",
  "bullBearCase": "What is the bull case and the bear case?",
